...
public class TerrainChunk
{
    ...
    public void Load()
    {
        ThreadedDataRequester.RequestData(() => HeightMapGenerator.GenerateHeightMap(meshSettings.numVertsPerRow, meshSettings.numVertsPerRow, heightMapSettings, sampleCenter), OnHeightMapReceived);
    }
